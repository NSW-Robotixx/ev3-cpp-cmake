...
//     ASSERT_EQ(line.getPoint1(), finder::math::Vector2(2, 2));
// }
...
//     ASSERT_EQ(line.getPoint2(), finder::math::Vector2(2, 2));
// }

// TEST(Line, getLength) {
//     finder::math::Line line(finder::math::Vector2(0, 0), finder::math::Vector2(3, 4));

//     ASSERT_EQ(line.getLength(), 5);
// }

// TEST(Line, getAngle) {
//     finder::math::Line line(finder::math::Vector2(0, 0), finder::math::Vector2(1, 1));

//     ASSERT_EQ((int)(line.getAngle()), 45.0);
// }

// TEST(Line, getAngle2) {
//     finder::math::Line line(finder::math::Vector2(0, 0), finder::math::Vector2(1, 0));

//     ASSERT_EQ(static_cast<int>(line.getAngle()), 0);
// }

// TEST(Line, getAngle3) {
//     finder::math::Line line(finder::math::Vector2(0, 0), finder::math::Vector2(0, 1));

//     ASSERT_EQ((int)(line.getAngle()), 90);
// }

// TEST(Line, getAngle4) {
//     finder::math::Line line(finder::math::Vector2(0, 0), finder::math::Vector2(-1, 0));

//     ASSERT_EQ((int)(line.getAngle()), 180.0);
// }

// TEST(Line, getAngle5) {
//     finder::math::Line line(finder::math::Vector2(0, 0), finder::math::Vector2(0, -1));

//     ASSERT_EQ((int)(line.getAngle()), -90.0);
// }
...
//     ASSERT_EQ(line1.getIntersection(line2), finder::math::Vector2(0.5, 0.5));
// }   
